...
<html>
    ...
    <a href="../cas1/logSystem.out.jsp" title="Logout">Click here to log out</a>
    </p>
    <p>A sample web application that exercises the CAS protocol features via the Java CAS Service Redirect.
    <a href="https://proxy.sso.hoau.com:443/cas/logout?service=https://app1.hoau.com:8413/cas1/logSystem.out.jsp" title="Logout">Click here to log out via CAS</a>
    </p>
    <hr>
